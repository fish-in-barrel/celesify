...
def render_data_explorer(inverse_map: dict[int, str], preprocess_report: dict | None = None) -> None:
    ...
    default_features = [col for col in ["alpha", "delta", "u", "g", "r", "i", "z", "redshift"] if col in feature_candidates]
    selected_features = st.multiselect(
        "Histogram features",
        options=feature_candidates,
        default=default_features[:4] if default_features else feature_candidates[:4],
